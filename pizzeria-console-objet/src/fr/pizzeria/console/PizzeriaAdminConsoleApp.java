...
public class PizzeriaAdminConsoleApp {
	...
	// * @return
	// */
	// private static Pizza createPizza(int id, String code, String nom, double
	// prix) {
	// Pizza p = new Pizza();
	// p.id = id;
	// p.code = code;
	...
	// "€)");
	// }
	// System.out.println("------- " + Pizza.nbPizzas + " pizzas créées depuis
	...
	// if (pizzaExists(code)) {
	// System.err.println("Erreur : La pizza avec le code " + code + " existe
	// déjà.");
	// return;
	// }
	...
	// */
	// private static void editPizza(String oldCode, String code, String name,
	// double price) {
	// if (!pizzaExists(oldCode)) {
	// System.err.println("Erreur : La pizza avec le code " + oldCode + "
	// n'existe pas.");
	// return;
	// }
